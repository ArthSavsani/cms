...
<html lang="en">
  <head>
    <title>Green Valley College</title>
    <meta charset="utf-8">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="http://localhost/AP/stu_fac/oneschool/index1.php">Green Valley College</a></div>
          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="#programs-section" class="nav-link">Attendance</a></li>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
            <h2 class="section-title">Populer Coursese We Offer</h2>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="owl-carousel col-12 nonloop-block-14">
            ...
            <div class="course bg-white h-100 align-self-stretch">
              ...
              <div class="course-inner-text py-4 px-4">
                ...
                <h3><a href="#">Learn Machine learning</a></h3>
                <p>This is a class that will teach you the end-to-end process of investigating 
                  data through a machine learning lens. It will teach you how to extract and
                   ...
                   important machine learning algorithms, and how to evaluate the performance 
                   of your machine learning algorithms. </p>
              </div>
            ...
            <div class="course bg-white h-100 align-self-stretch">
              ...
              <div class="course-inner-text py-4 px-4">
               <!---- <span class="course-price">$99</span>-->
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Learn Deep Learning</a></h3>
                <p>This course provides an introduction to Deep Learning, a field that aims to harness
                  the enormous amounts of data that we are surrounded by with artificial neural
                   networks, allowing for the development of self-driving cars, speech interfaces,
                    genomic sequence analysis and algorithmic trading. </p>
              </div>
              <div class="d-flex border-top stats">
               <!---- <div class="py-3 px-4"><span class="icon-users"></span> 2,193 students</div>
                <div class="py-3 px-4 w-25 ml-auto border-left"><span class="icon-chat"></span> 2</div>-->
            ...
            <div class="course bg-white h-100 align-self-stretch">
              ...
              <div class="course-inner-text py-4 px-4">
               <!---- <span class="course-price">$99</span>-->
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Learn Artifical Inteligence</a></h3>
                <p>This course will introduce you to the basics of AI. Topics include machine 
            ...
            <div class="course bg-white h-100 align-self-stretch">
              ...
              <div class="course-inner-text py-4 px-4">
               <!---- <span class="course-price">$99</span>-->
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Learn Data Science</a></h3>
                <p>This course takes you one step closer to becoming a data scientist
                  by offering a subset of the topics covered in our Data Science Bootcamp. 
                  You'll get a well-rounded intro to the core concepts and technologies 
                  taught within the bootcamp, including basic machine learning principles 
                  and hands-on coding experience.</p>
              </div>
              <div class="d-flex border-top stats">
               <!---- <div class="py-3 px-4"><span class="icon-users"></span> 2,193 students</div>
                <div class="py-3 px-4 w-25 ml-auto border-left"><span class="icon-chat"></span> 2</div>-->
            ...
            <div class="course bg-white h-100 align-self-stretch">
              ...
              <div class="course-inner-text py-4 px-4">
                <!--<span class="course-price">$99</span>-->
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Learn Surveying</a></h3>
                <p>This course introduces elementary plane surveying to students of surveying, 
                  civil engineering and environmental engineering. It covers basic concepts of
                   surveying relating to such things as coordinate systems, contouring, an
                    introduction to road design, basic surveying equipment and its usage.</p>
              </div>
              <div class="d-flex border-top stats">
               <!---- <div class="py-3 px-4"><span class="icon-users"></span> 2,193 students</div>
                <div class="py-3 px-4 w-25 ml-auto border-left"><span class="icon-chat"></span> 2</div>-->
            ...
            <div class="course bg-white h-100 align-self-stretch">
              ...
              <div class="course-inner-text py-4 px-4">
                <!--<span class="course-price">$20</span>-->
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Learn Designing</a></h3>
                <p>Everyone designs. Design occurs anytime you deliberately 
                  change an environment to make things better. This course provides a 
                  summary of key concepts  of The Design of Everyday Things.It’s intended to be enjoyable 
                  and informative for anyone curious about design: everyday people, technical people, designers, and non-designers alike. </p>
              </div>
              <div class="d-flex border-top stats">
                <!--<div class="py-3 px-4"><span class="icon-users"></span> 2,193 students</div>
                <div class="py-3 px-4 w-25 ml-auto border-left"><span class="icon-chat"></span> 2</div>-->
            ...
            <div class="course bg-white h-100 align-self-stretch">
              ...
              <div class="course-inner-text py-4 px-4">
               <!---- <span class="course-price">$99</span>-->
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Learn JS</a></h3>
                <p>Learn the fundamentals of JavaScript, the most popular programming language
                  in web development.You will learn programming fundamentals and basic object-oriented
                   concepts using the latest JavaScript syntax. The concepts covered in these lessons
                    lay the foundation for using JavaScript in any environment. </p>
              </div>
              <div class="d-flex border-top stats">
               <!---- <div class="py-3 px-4"><span class="icon-users"></span> 2,193 students</div>
                <div class="py-3 px-4 w-25 ml-auto border-left"><span class="icon-chat"></span> 2</div>-->
            ...
            <div class="course bg-white h-100 align-self-stretch">
              ...
              <div class="course-inner-text py-4 px-4">
               <!----> <span class="course-price">$99</span>-->
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Learn  Robotics</a></h3>
                <p>The Introduction to Robotics Specialization introduces you to the concepts of 
                  robot flight and movement, how robots perceive their environment, and how they 
                  adjust their movements to avoid obstacles, navigate difficult terrains and accomplish 
                  complex tasks such as construction and disaster recovery. You will be exposed to real
                   world examples of how robots have been applied in disaster situations. </p>
              </div>
              <div class="d-flex border-top stats">
               <!---- <div class="py-3 px-4"><span class="icon-users"></span> 2,193 students</div>
                <div class="py-3 px-4 w-25 ml-auto border-left"><span class="icon-chat"></span> 2</div>-->
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 text-center"  data-aos="fade-up" data-aos-delay="">
           ...
           <!---- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam repellat aut neque! Doloribus sunt non 
             aut reiciendis, vel recusandae obcaecati hic dicta repudiandae in quas quibusdam ullam, illum sed veniam!</p>-->
          </div>
        </div>
